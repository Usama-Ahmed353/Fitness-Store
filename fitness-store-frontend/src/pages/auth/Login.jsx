    ...
    >
      <Card className="w-full max-w-md" variant="default">
        <div className="p-8">
          ...
          <p className="text-light-bg/70 text-center mb-8">
            Sign in to your CrunchFit Pro account
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a href="#" className="text-accent hover:text-accent/90 transition-colors">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-light-bg/70 text-center mt-6">
            ...
            <a href="/register" className="text-accent hover:text-accent/90 transition-colors">
              Create one
            </a>
          </p>
        </div>
